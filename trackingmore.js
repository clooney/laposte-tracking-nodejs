...
//2 识别一个运输商
// var postData = {"tracking_number":"6A15651349859"};
...
//4 获取多个运单号的物流信息
// var postData = null;
// var url      = 'http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=6A15651349859&orders=&lang=cn';
// sentRes(url,postData,"GET",function(data){
//     console.log(data);
// });
...
//5 列出单个运单号物流信息
// var postData = null;
// var url      = 'http://api.trackingmore.com/v2/trackings/laposte/6A15651349859/en';
// sentRes(url,postData,"GET",function(data){
//     console.log(data);
// });
...
// var url       = 'http://api.trackingmore.com/v2/trackings/laposte/6A15651349859';
...
// var postData = [{"carrier_code":"laposte","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}];
...
//14 修改多个运单号附加信息
// var postData = [
//     {"tracking_number":"6A15651349859","carrier_code":"laposte","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","destination_code":"US","status":"7","logistics_channel":"API TEST"},
...
//16 修改运输商简码
// var postData = {"tracking_number":"6A15651349859","carrier_code":"laposte","update_carrier_code":"china-ems"};
...
//17 获取单次跟踪的实时结果
// var postData = {"tracking_number": "6A15651349859","carrier_code":"laposte","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"};
